				      ...
				      <div class="movie-browse-agile">
						...
						<div class="browse-agile-w3ls general-w3ls">
							   ...
							   <div class="col-md-2 w3l-movie-gride-agile">
										 <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h1.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">Before I Wake</a></h6>							
										</div>
										<div class="mid-2">
								   ...
								   <div class="col-md-2 w3l-movie-gride-agile">
										 <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h2.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">Don't Breathe</a></h6>							
										</div>
										<div class="mid-2">
								    ...
								    <div class="col-md-2 w3l-movie-gride-agile">
										 <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h3.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">The Shallows</a></h6>							
										</div>
										<div class="mid-2">
									...
									<div class="col-md-2 w3l-movie-gride-agile">
										  <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h4.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">Hush</a></h6>							
										</div>
										<div class="mid-2">
							 	    ...
							 	    <div class="ribben">
										...
										<div class="col-md-2 w3l-movie-gride-agile">
										<a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h5.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">Tell Me How I Die</a></h6>							
										</div>
										<div class="mid-2">
									...
									<div class="col-md-2 w3l-movie-gride-agile">
										 <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h6.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">The Veil</a></h6>							
										</div>
										<div class="mid-2">
							...
							<!-- //latest-movies1 -->
							    ...
							    <div class="browse-inner-come-agile-w3">
							   <div class="col-md-2 w3l-movie-gride-agile">
										 <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h7.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">Dead 7</a></h6>							
										</div>
										<div class="mid-2">
								   ...
								   <div class="col-md-2 w3l-movie-gride-agile">
										 <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h8.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">Keep Watching</a></h6>							
										</div>
										<div class="mid-2">
								    ...
								    <div class="col-md-2 w3l-movie-gride-agile">
										 <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h9.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">Holidays</a></h6>							
										</div>
										<div class="mid-2">
									...
									<div class="col-md-2 w3l-movie-gride-agile">
										  <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h10.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">The Neon Demon</a></h6>							
										</div>
										<div class="mid-2">
							 	    ...
							 	    <div class="ribben">
										...
										<div class="col-md-2 w3l-movie-gride-agile">
										<a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h11.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">Morgan </a></h6>							
										</div>
										<div class="mid-2">
									...
									<div class="col-md-2 w3l-movie-gride-agile">
										 <a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/h12.jpg" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
											<h6><a href="single.jsp">The Belko Experiment</a></h6>							
										</div>
										<div class="mid-2">
						 ...
						 <div class="container">
						 	<div class="w3_agile_banner_bottom_grid">
								<div id="owl-demo" class="owl-carousel owl-theme">
									...
									<div class="item">
										<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
											<a href="single.jsp" class="hvr-shutter-out-horizontal"><img src="images/m12.jpg" title="album-name" class="img-responsive" alt=" " />
												<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
											</a>
											<div class="mid-1 agileits_w3layouts_mid_1_home">
												<div class="w3l-movie-text">
													<h6><a href="single.jsp">Greater</a></h6>							
												</div>
												<div class="mid-2 agile_mid_2_home">
													<p>2016</p>
													<div class="block-stars">
