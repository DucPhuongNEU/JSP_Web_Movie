...
/**
 * Servlet implementation class UpdateMovieDetailAction
 */
@WebServlet("/UpdateMovieDetailAction")
public class UpdateMovieDetailAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateMovieDetailAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (episodelink == null) {
			try {
				md.setEpisodelink(new MovieDetailModel().getMovieDetailByIdmoviedetail(idmoviedetail).getEpisodelink());
		...
		try {
			new MovieDetailModel().updateMovieDetail(md);
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
